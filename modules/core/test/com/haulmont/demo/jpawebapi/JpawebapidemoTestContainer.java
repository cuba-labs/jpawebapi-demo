...
public class JpawebapidemoTestContainer extends TestContainer {

    public JpawebapidemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/demo/jpawebapi/app.properties",
    ...
    public static class Common extends JpawebapidemoTestContainer {

        public static final JpawebapidemoTestContainer.Common INSTANCE = new JpawebapidemoTestContainer.Common();
