...
import com.haulmont.demo.jpawebapi.http.rest.jmx.SampleJmxService;
...
public class RowLevelSecurityFT {
    ...
    public void testCreateAndUpdateCarWithToken() throws Exception {
        ...
        String createUrl = "/entities/ref_Car/";
        ...
        String url = "/entities/ref_Car/" + newCarId.toString();
    ...
    public void testOneToManyComposition() throws Exception {
        String url = "/entities/ref_Car/" + carId.toString();
        ...
        String updateUrl = "/entities/ref_Car/" + carId;
    ...
    public void testManyToMany() throws Exception {
        String url = "/entities/ref$Plant/" + plantId;
        Map<String, String> params = new HashMap<>();
        ...
        String updateUrl = "/entities/ref$Plant/" + plantId;
        try (CloseableHttpResponse response = sendPut(updateUrl, userToken, updateJson, null)) {
            assertEquals(HttpStatus.SC_OK, statusCode(response));
        }
