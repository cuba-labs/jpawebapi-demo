...
//import com.haulmont.demo.jpawebapi.http.rest.jmx.CoreCachingFacadeJmxService;
//import com.haulmont.demo.jpawebapi.http.rest.jmx.WebCachingFacadeJmxService;
//import com.haulmont.demo.jpawebapi.http.rest.jmx.WebConfigStorageJmxService;
...
//        executePrepared("delete from REF_IK_CUSTOMER");
//        if (conn != null) {
//            conn.close();
//        }
//    }
...
//        String invalidId = "A";
//        String url = "/entities/ref_Car/" + invalidId;
//        Map<String, String> params = new HashMap<>();
//        try (CloseableHttpResponse response = sendGet(url, oauthToken, params)) {
//            assertEquals(HttpStatus.SC_BAD_REQUEST, statusCode(response));
//            ReadContext ctx = parseResponse(response);
...
//        String url = "/entities/ref$ExtDriver/" + driverUuidString;
//        Map<String, String> params = new HashMap<>();
...
//        String url = "/entities/ref$ExtDriver";
//        Map<String, String> params = new HashMap<>();
//        params.put("view", "test1");
...
//        String url = "/entities/ref_Car/" + randomId;
//        try (CloseableHttpResponse response = sendGet(url, oauthToken, null)) {
...
//        UUID randomId = UUID.randomUUID();
//        String url = "/entities/ref$NonExistingMetaClass/" + randomId;
//        try (CloseableHttpResponse response = sendGet(url, oauthToken, null)) {
//            assertEquals(HttpStatus.SC_NOT_FOUND, statusCode(response));
//            ReadContext ctx = parseResponse(response);
...
//        params.put("offset", "2");
//        params.put("sort", "name");
//        try (CloseableHttpResponse response = sendGet(url, token, params)) {
//            assertEquals(HttpStatus.SC_OK, statusCode(response));
//            ReadContext ctx = parseResponse(response);
...
//        String json = getFileContent("updateCarWithDynamicAttribute.json", replacements);
//
//        String url = "/entities/ref_Car/" + secondCarUuidString;
//        try (CloseableHttpResponse response = sendPut(url, oauthToken, json, null)) {
//            assertEquals(HttpStatus.SC_OK, statusCode(response));
//            ReadContext ctx = parseResponse(response);
...
//        String json = getFileContent("updateCar.json", replacements);
//
//        String url = "/entities/ref_Car/" + carId;
//        try (CloseableHttpResponse response = sendPut(url, oauthToken, json, null)) {
//            assertEquals(HttpStatus.SC_NOT_FOUND, statusCode(response));
//        }
//    }
...
//        Map<String, String> replacements = new HashMap<>();
//        String json = getFileContent("invalidDriver.json", replacements);
//        String url = "/entities/ref$Driver/" + driverUuidString;
//        try (CloseableHttpResponse response = sendPut(url, oauthToken, json, null)) {
//            assertEquals(HttpStatus.SC_BAD_REQUEST, statusCode(response));
//            ReadContext ctx = parseResponse(response);
//            assertEquals("Cannot deserialize an entity from JSON", ctx.read("$.error"));
...
//
//        String url = "/entities/ref$Plant/" + plantUuidString;
//        try (CloseableHttpResponse response = sendPut(url, oauthToken, json, null)) {
//            assertEquals(HttpStatus.SC_OK, statusCode(response));
//        }
//
...
//
//        String url = "/entities/ref$IdentityCustomer";
//        Long customerId;
//        try (CloseableHttpResponse response = sendPost(url, oauthToken, json, null)) {
//            assertEquals(HttpStatus.SC_CREATED, statusCode(response));
//            ReadContext ctx = parseResponse(response);
...
//        String url = "/entities/ref_Car/" + UUID.randomUUID();
//        try (CloseableHttpResponse response = sendDelete(url, oauthToken, null)) {
//            assertEquals(HttpStatus.SC_NOT_FOUND, statusCode(response));
//        }
//    }
...
//        String url = "/entities/ref$OldCar";
//        Map<String, String> params = new HashMap<>();
//        params.put("modelVersion", "1.0");
//        params.put("view", "carBrowse");
//
...
//        String url = "/entities/ref$Repair/" + repairUuidString;
//        Map<String, String> params = new HashMap<>();
//        params.put("modelVersion", "1.0");
//
//        try (CloseableHttpResponse response = sendGet(url, oauthToken, params)) {
...
//
//        UUID repairId;
//        String url = "/entities/ref$OldRepair";
//
//        Map<String, String> params = new HashMap<>();
//        params.put("modelVersion", "1.0");
//
