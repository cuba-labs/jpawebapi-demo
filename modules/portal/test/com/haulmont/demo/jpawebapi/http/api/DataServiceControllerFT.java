...
public class DataServiceControllerFT {
    ...
    private void prepareDb() throws SQLException {
        ...
        executePrepared("insert into sys_attr_value(id, category_attr_id, entity_id, string_value, version) values (?, ?, ?, ?, 1)",
        ...
        executePrepared("insert into sys_attr_value(id, category_attr_id, entity_id, entity_value, version) values (?, ?, ?, ?, 1)",
